...
#define BAUD_RATE_PORT              4
#define CAN_RX_CONTROL_PORT         1

static uint32_t g_can_base_address = STIMULATOR_CAN_BASE_ID;
...
static void init_can_gpio(void)
{
        ...
        // CANFilter shiftx2_can_filter = {1, 0, 1, 0, 0x000E3700, 0x1FFFFF00}; // g_can_base_address, STIMULATOR_CAN_FILTER_MASK
...
static void init_can_operating_parameters(void)
{
        ...
        g_can_base_address += (STIMULATOR_CAN_API_RANGE * offset);
}
